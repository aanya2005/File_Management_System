...
"""
DsuFileError is a custom exception
handler that you should catch in your own code. It
is raised when attempting to load or
...
class Post(dict):
    ...
    def set_time(self, entry_time: float):
        self._timestamp = entry_time
        dict.__setitem__(self, 'timestamp', entry_time)
    ...
    time values. When the value for entry is changed, or set,
...
class Profile:
    ...
    functions in this class as you will
    ...
    posts that have been added to the
    Profile object
